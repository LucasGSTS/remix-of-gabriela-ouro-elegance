...
const Treatments = () => {
  ...
  return (
    <section id="tratamentos" className="py-16 md:py-24 bg-card">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto">
          {treatments.map((treatment, index) => (
            ...
            >
              ...
              <div className="relative h-full p-6 md:p-8 rounded-2xl bg-card/70 backdrop-blur-sm border border-primary/20 hover:border-primary/40 transition-all duration-500 hover:shadow-2xl hover:-translate-y-2">
                <div className="inline-flex items-center justify-center w-14 h-14 md:w-16 md:h-16 rounded-full bg-primary/10 mb-5 md:mb-6 group-hover:bg-primary/20 transition-colors">
                  <treatment.icon className="h-7 w-7 md:h-8 md:w-8 text-primary" />
                </div>

                <h3 className="font-serif text-xl md:text-2xl text-foreground mb-3 md:mb-4">{treatment.title}</h3>
                <p className="text-foreground/70 mb-5 md:mb-6 leading-relaxed text-sm md:text-base">{treatment.description}</p>
